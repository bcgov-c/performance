...
class AddIndexToEmployeeDemo2 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->createTableIndexIfNotExist('employee_demo', 'idx_employee_demo_employeeid_record', ['employee_id', 'empl_record']);
        $this->createTableIndexIfNotExist('employee_demo', 'idx_employee_demo_employeeid_name_email', ['employee_id', 'employee_name', 'employee_email']);
    }
    ...
    {
        $this->dropExistingTableIndex('employee_demo', 'idx_employee_demo_employeeid_record');
        $this->dropExistingTableIndex('employee_demo', 'idx_employee_demo_employeeid_name_email');
    }
