...
class CreateEmployeeDemoViews extends Migration
{
    ...
    public function up()
    {
        ...
        self::createView("users_active_by_org_vw", self::$users_employeedemo_sql, self::$where_active, self::$order_by_org);
        self::createView("users_active_by_dept_vw", self::$users_employeedemo_sql, self::$where_active, self::$order_by_dept);
    }
    ...
    public function createView($viewName, $viewSQL, $viewWhere, $viewOrderBy) {
        \DB::statement('
