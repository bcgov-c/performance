...
class CreateHrUserDemoJrHistoryView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        \DB::statement("
            CREATE VIEW hr_user_demo_jr_history_view
            AS
            SELECT DISTINCT
            ...
            ORDER BY ao.user_id, u.employee_id, j.id
        ");
    }
    ...
    {
        \DB::statement("
            DROP VIEW hr_user_demo_jr_history_view
        ");
    }
