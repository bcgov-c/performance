...
class AddIndexToEmployeeDemo3 extends Migration
{
    ...
    public function up()
    {
        $this->createTableIndexIfNotExist('employee_demo', 'idx_employee_demo_employeeid_orgid', ['employee_id', 'orgid']);
    }
    ...
    {
        $this->dropExistingTableIndex('employee_demo', 'idx_employee_demo_employeeid_orgid');
    }
