...
class AddIndexOnEmployeeDemo4 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->createTableIndexIfNotExist('employee_demo', 'idx_employee_demo_position_number_employee_id', ['position_number', 'employee_id']);
    }
    ...
    {
        $this->dropExistingTableIndex('employee_demo', 'idx_employee_demo_position_number_employee_id');
    }
