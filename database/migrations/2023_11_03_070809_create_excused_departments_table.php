...
class CreateExcusedDepartmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('excused_departments');
        Schema::create('excused_departments', function (Blueprint $table) {
            $table->id();
