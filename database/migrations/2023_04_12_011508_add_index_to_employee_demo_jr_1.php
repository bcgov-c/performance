...
class AddIndexToEmployeeDemoJr1 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->createTableIndexIfNotExist('employee_demo_jr', 'idx_employee_demo_jr_employeeid_id', ['employee_id', 'id']);
    }
    ...
    {
        $this->dropExistingTableIndex('employee_demo_jr', 'idx_employee_demo_jr_employeeid_id');
    }
