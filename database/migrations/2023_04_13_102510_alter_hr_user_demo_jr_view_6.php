...
class AlterHrUserDemoJrView6 extends Migration
{
    /**
     * Run the migrations.
     *
            ...
            FROM 
				...
				INNER JOIN admin_orgs 
					...
					ON o.version = 2
						AND o.inherited = 1
						AND (
							   EXISTS (SELECT DISTINCT 1 FROM employee_demo_tree l0, admin_orgs o2 WHERE o2.user_id = o.user_id AND o2.inherited = 1 AND o2.version = 2 AND l0.id = o2.orgid AND l0.level = 0 AND l0.organization_key = ua.organization_key)
							OR EXISTS (SELECT DISTINCT 1 FROM employee_demo_tree l1, admin_orgs o2 WHERE o2.user_id = o.user_id AND o2.inherited = 1 AND o2.version = 2 AND l1.id = o2.orgid AND l1.level = 1 AND l1.organization_key = ua.organization_key AND l1.level1_key = ua.level1_key)
							OR EXISTS (SELECT DISTINCT 1 FROM employee_demo_tree l2, admin_orgs o2 WHERE o2.user_id = o.user_id AND o2.inherited = 1 AND o2.version = 2 AND l2.id = o2.orgid AND l2.level = 2 AND l2.organization_key = ua.organization_key AND l2.level1_key = ua.level1_key AND l2.level2_key = ua.level2_key)
							OR EXISTS (SELECT DISTINCT 1 FROM employee_demo_tree l3, admin_orgs o2 WHERE o2.user_id = o.user_id AND o2.inherited = 1 AND o2.version = 2 AND l3.id = o2.orgid AND l3.level = 3 AND l3.organization_key = ua.organization_key AND l3.level1_key = ua.level1_key AND l3.level2_key = ua.level2_key AND l3.level3_key = ua.level3_key)
							OR EXISTS (SELECT DISTINCT 1 FROM employee_demo_tree l4, admin_orgs o2 WHERE o2.user_id = o.user_id AND o2.inherited = 1 AND o2.version = 2 AND l4.id = o2.orgid AND l4.level = 4 AND l4.organization_key = ua.organization_key AND l4.level1_key = ua.level1_key AND l4.level2_key = ua.level2_key AND l4.level3_key = ua.level3_key AND l4.level4_key = ua.level4_key)
						)
            WHERE d.date_deleted IS NULL
