...
class DataFix_1237_Initialize_Model_Has_Role_Audits_HR extends Seeder
{
    /**
    ...
    public function run()
    {
        $this->command->info(Carbon::now()." - Begin setup initial deptid and position number in model_has_role_audits table for HR Admin.");
        \DB::statement("
        ...
        ");
        $this->command->info(Carbon::now()." - End setup initial deptid and position number in model_has_role_audits table for HR Admin.");
    }
}
