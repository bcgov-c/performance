...
<p>If you require assistance with sharing an employee, please submit a service request through <a target="blank" href="https://www2.gov.bc.ca/gov/content/careers-myhr">AskMyHR</a> to My Team or Organization > HR Software Systems Support > Performance Development Platform.</p>
<br>

<u>Excused Status</u>
<br><br>
<p>Clicking on the Yes/No below the “Excuse” column header launches the employee excused window. This provides any details on the reason the employee has previously been excused and the dates covered by the excused status. It also allows the supervisor to create a new excused status if needed.</p>
<p>All employees are required to complete at least one performance conversation every four months. Employees may be excused from completing a conversation only if they fit into one of the categories listed in the dropdown box. Excusing an employee will remove them from any reporting and will pause the employee&rsquo;s conversation deadlines during the date range selected.</p>
<br>

<u>Viewing Employee Profiles</u>
<br><br>
<p>Clicking on an employee name will take you to the supervisor view of their profile. Here you can see the details of their current and past goals. Clicking on a goal card in their profile allows you to review the details of the goal and provide feedback in the comments section. The employee will receive a notification when a new comment is added to one of their goals.</p>
...
<p><i>Delegate (Shared) Supervisor Tip: you will only have access to the sections of the employee profile that have been shared with you. It is possible to share only the goals section, only the conversations section, or both</i></p>
