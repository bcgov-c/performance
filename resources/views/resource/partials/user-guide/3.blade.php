...
<p>Every employee must record at least one performance conversation every four months (three per year). However, the topic and nature of each performance conversation does not have to be the same. The PDP has templates to support conversations focused on onboarding a new employee, goal setting, performance check-ins, performance improvement, and career development. Each of these count as a performance conversation. Check out the resource on <a href='/resource/conversations?t=6' target=\'_blank\'>Performance Conversation Templates</a> to see all the options and suggestions for when to use each one.</p>
...
<br><br>
<p>This area lists all the performance conversation templates available for use. Each templates includes suggestions for when to use it, tips on how employees and supervisors can prepare for the conversation, and a list of questions to consider in advance or during the conversation to guide discussion. You may also want to check out the resource on <a href='/resource/conversations?t=6' target=\'_blank\'>Performance Conversation Templates</a> to see more details on all the options and examples for when to use each one.</p>
