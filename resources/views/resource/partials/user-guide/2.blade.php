<!-- My Goals Section -->
<p>The My Goals section is a collaborative space where employees and supervisors can set work, learning, or career development goals and track progress against agreed upon measures of success.</p>
<p>Each goal has a comments section to capture updates and feedback. Comments made here are not considered part of an official performance review. Feel free to use this area to provide ongoing feedback and recognition as needed and then refer to this area when preparing for the official performance conversations captured in the My Conversations area.</p>
...
<u>Goal Bank</u>
<br><br>
<p>This is a list of goals created for you by your supervisor or organization. Some goals will be marked as mandatory, but most are just suggested starting points for you to consider. This is a good place to start if you want to search for goal ideas on a certain topic. You will receive a notification when a new goal is added to your Goal Bank.</p>
<p>Click on a goal to view it and add it to your own profile. If needed, you can edit the goal to personalize it once it is in your own profile.</p> 
<p><i></i>Supervisor Tip: you will see an additional option on the bottom half of this page to manage your team’s goal bank. This is where you can add suggested or mandatory goals for your team members. The process of creating a goal is almost identical to creating a new goal for yourself. The only additional step is selecting the audience for the goal. Each audience member will receive a notification and will see this goal in their own Goal Bank.</i></p>
