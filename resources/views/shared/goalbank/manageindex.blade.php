            ...
            $('#btn_search').click(function(e) {
                ...
                $('#filtertable').DataTable ( {
                    ...
                    [
                        ...
                        {title: 'Display Name', ariaTitle: 'Display Name', target: 0, type: 'string', data: 'click_display_name', name: 'click_display_name', searchable: true, className: 'dt-nowrap'},
                        ...
                        {title: 'Created By Organization', ariaTitle: 'Created By Organization', target: 0, type: 'string', data: 'click_creator_organization', name: 'click_creator_organization', searchable: true, className: 'dt-nowrap'},
