...
@push('js')
    ...
    <script>
        $('#add_level0').select2({
            ...
            allowClear: true,
            ajax: {
                url: '{{ "/" . request()->segment(1) . "/goalbank/aorg-organizations" }}'
                , dataType: 'json'
                , delay: 250
        ...
        $('#add_level1').select2({
            ...
            allowClear: true,
            ajax: {
                url: '{{ "/" . request()->segment(1) . "/goalbank/aorg-programs" }}'
                , dataType: 'json'
                , delay: 250
                , data: function(params) {
                    var query = {
        ...
        $('#add_level2').select2({
            ...
            allowClear: true,
            ajax: {
                url: '{{ "/" . request()->segment(1) . "/goalbank/aorg-divisions" }}'
                , dataType: 'json'
                , delay: 250
                , data: function(params) {
                    var query = {
        ...
        $('#add_level3').select2({
            ...
            allowClear: true,
            ajax: {
                url: '{{ "/" . request()->segment(1) . "/goalbank/aorg-branches" }}'
                , dataType: 'json'
                , delay: 250
                , data: function(params) {
                    var query = {
        ...
        $('#add_level4').select2({
            ...
            allowClear: true,
            ajax: {
                url: '{{ "/" . request()->segment(1) . "/goalbank/aorg-level4" }}'
                , dataType: 'json'
                , delay: 250
                , data: function(params) {
                    var query = {
