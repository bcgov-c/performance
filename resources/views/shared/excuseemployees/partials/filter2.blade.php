    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#edd_level0').select2({
                ...
                allowClear: true,
                ajax: {
                    url: '{{ "/".request()->segment(1)."/eorg-organizations2" }}'
                    , dataType: 'json'
                    , delay: 250
            ...
            $('#edd_level1').select2({
                ...
                allowClear: true,
                ajax: {
                    url: '{{ "/".request()->segment(1)."/eorg-programs2" }}'
                    , dataType: 'json'
                    , delay: 250
                    , data: function(params) {
                        var query = {
            ...
            $('#edd_level2').select2({
                ...
                allowClear: true,
                ajax: {
                    url: '{{ "/".request()->segment(1)."/eorg-divisions2" }}'
                    , dataType: 'json'
                    , delay: 250
                    , data: function(params) {
                        var query = {
            ...
            $('#edd_level3').select2({
                ...
                allowClear: true,
                ajax: {
                    url: '{{ "/".request()->segment(1)."/eorg-branches2" }}'
                    , dataType: 'json'
                    , delay: 250
                    , data: function(params) {
                        var query = {
            ...
            $('#edd_level4').select2({
                ...
                allowClear: true,
                ajax: {
                    url: '{{ "/".request()->segment(1)."/eorg-level42" }}'
                    , dataType: 'json'
                    , delay: 250
                    , data: function(params) {
                        var query = {
