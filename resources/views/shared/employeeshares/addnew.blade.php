    ...
    <x-slot name="js">
        ...
        <script>
            ...
            function confirmSaveAllModal(){
                ...
                $('#saveAllModal .modal-body p').html('Are you sure you want to share <b>'+countProf+'</b> employee(s) with <b>'+countSupv+'</b> supervisor(s)? This will allow the supervisor(s) to view, comment, and sign-off on the shared profiles.<br><br>Note: If you have any concerns about the employee count, please cancel and reach out to your <a href="/resources/contact" target="_blank">ministry contact</a>.');
                $('#saveAllModal').modal();
			}
                ...
                $('#eemployee-list-table').DataTable( {
                    ...
                    drawCallback: function ( settings ) {
                        ...
                        $.ajax({
                            url: '{{ "/" . request()->segment(1) . "/employeeshares/getfilteredlist" }}',
                            data: {
                                edd_level0 : $('#edd_level0').val(),
                                edd_level1 : $('#edd_level1').val(),
                                edd_level2 : $('#edd_level2').val(),
                                edd_level3 : $('#edd_level3').val(),
                                edd_level4 : $('#edd_level4').val(),
                                ecriteria : $('#ecriteria').val(),
                                esearch_text : $('#esearch_text').val(),
                                option : 'e',
                            },
                            type: 'GET',
                            success: function (data) {
