            ...
            $(document).ready(function() {
                $('#listtable').DataTable ( {
                    ...
                    [
                        ...
                        {title: 'Reports To Name', ariaTitle: 'Reports To Name', target: 0, type: 'string', data: 'supervisor_name', name: 'u.supervisor_name', searchable: false, className: 'dt-nowrap show-modal'},
