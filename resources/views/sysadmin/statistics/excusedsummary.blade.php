<x-side-layout title="{{ __('Statistic and Reports - Performance Development Platform') }}">
	...
	<form id="filter-form" class="no-print">
		...
		@include('sysadmin.statistics.partials.filter',['formaction' => route('sysadmin.statistics.excusedsummary') ])
...
$(function() {
	...
	var allCharts = [];
	var export_url = '{{ route('sysadmin.statistics.excusedsummary.export') }}';
