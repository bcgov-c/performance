<x-side-layout title="{{ __('Statistic and Reports - Performance Development Platform') }}">
	...
	<form id="filter-form" class="no-print">
		...
		@include('my-team.statistics.partials.filter',['formaction' => route('my-team.statistics.sharedsummary') ])
...
$(function() {
	...
	var allCharts = [];
	var export_url = '{{ route('my-team.statistics.sharedsummary.export') }}';
