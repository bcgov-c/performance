...
class SyncUserProfile extends Command
{
    ...
    protected function SyncUserProfile($last_sync_at, $new_sync_at, $audit_id, &$exceptions)
    {
            ...
            if ($user) {
                ...
                if ($dup_email) {
                    ...
                    try {
                        ...
                        echo 'Unable to update user profile for EID # '.$employee->employee_id.'.'; echo "\r\n";
                        DB::rollback();
                    }
            ...
            //   } else {
                ...
                if ($dup_email) {
                    ...
                    try {
                        ...
                        echo 'Unable to create user profile for EID # '.$employee->employee_id.'.'; echo "\r\n";
                        DB::rollback();
                    }
                }
