...
Route::group(
    ...
    function () {
        ...
        Route::middleware(
            ...
            function () {
                Route::resource('/job-schedule-audit', JobSchedAuditController::class)->only(
                    ['index','show']
                );
            }
        );
...
Route::group(
    ['middleware' => ['role:Sys Admin|Service Representative']],
    function () {
        //Shared functions v3.0
